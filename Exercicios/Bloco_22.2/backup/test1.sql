...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`filizzola`@`localhost`*/ /*!50003 TRIGGER `trigger_OrderDate_insert` BEFORE INSERT ON `orders` FOR EACH ROW BEGIN
...
-- Dump completed on 2021-09-01 10:56:26
